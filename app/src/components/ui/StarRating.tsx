...
/**
 * The 1-to-10 admin rating indicator. Renders ten star pips; filled pips are lime, empty are hairline.
  ...
  return (
    <div style={{ display: "inline-flex", alignItems: "center", gap: 12, ...style }}>
      ...
      {showValue && (
        ...
        >
          {active}
          <span style={{ color: "var(--text-tertiary)", fontSize: size * 0.7 }}>/{max}</span>
        </span>
      )}
    </div>
  );
