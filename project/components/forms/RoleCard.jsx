...
export function RoleCard({
  ...
  return (
    ...
    >
      <span style={{
        width: 56, height: 56, flexShrink: 0, borderRadius: 'var(--radius-md)',
      ...
      <span style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1, minWidth: 0 }}>
        <span style={{
          ...
          fontWeight: 'var(--fw-bold)', color: 'var(--text-primary)', letterSpacing: '-0.01em',
        }}>{title}</span>
        <span style={{
          fontFamily: 'var(--font-body)', fontSize: 'var(--text-sm)',
          color: 'var(--text-secondary)', lineHeight: 'var(--lh-snug)',
        }}>{description}</span>
      </span>
      <span style={{
        ...
        color: 'var(--on-accent)', fontSize: 13, fontWeight: 700,
